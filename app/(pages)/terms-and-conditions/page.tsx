  ...
  return (
    <div className='min-h-screen bg-black text-white'>
      <div className='container mx-auto px-8 py-16'>
        ...
        <div className='max-w-4xl mx-auto bg-[#1a1a1a] p-8 rounded-lg space-y-12'>
          <section>
            ...
            <p className='text-gray-300 leading-relaxed'>
              ...
              &quot;us&quot;, and &quot;our&quot; refer to SOFI AI TECH SOLUTION
              INC. The term &quot;you&quot; refers to the person using SOFI AI
              TECH SOLUTION INC Website. By using the website, app.sofitech.ai,
              you are agreeing to the following terms and conditions below.
              Please read through these terms and conditions thoroughly, and if
              you choose not to accept the terms and conditions, you should not
              use the conditions, you should not use the SOFI AI TECH SOLUTION
              INC platform.
            </p>
          </section>
          ...
          <section>
            ...
            <div className='text-gray-300 leading-relaxed space-y-4'>
              ...
              <p>
                Any use by you of optional tools offered through this site is
                ...
                through our website (including, the release of new tools and
          ...
          <section>
            ...
            <div className='text-gray-300 leading-relaxed space-y-4'>
              <p>
                ...
                obligation (1) forward to us. We are and shall be under no
          ...
          <section>
            ...
            <div className='text-gray-300 leading-relaxed space-y-4'>
              ...
              <p>
                In no case shall SOFI AI TECH SOLUTION INC, our directors,
          ...
          <section>
            ...
            <div className='text-gray-300 leading-relaxed space-y-4'>
              <p>
                You agree to indemnify, defend and hold harmless SOFI AI TECH
                SOLUTION INC and our parent, subsidiaries, affiliates, partners,
