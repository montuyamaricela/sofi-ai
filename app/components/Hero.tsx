        ...
        <div className='space-y-5 lg:space-y-8'>
          ...
          <motion.div variants={animationVariant('y', 20)}>
            <p className=' text-primary-grayText'>
              ...
              Scale the way you engage your customers with intuitive, AI-enabled
              automation. Increase your online sales efficiency, enhance your
              customer experience, and effortlessly sell more.
            </p>
          </motion.div>
